...
type AttendeeTileProps = BaseAttendeeTileProps & {
  props?: Except<
...
export const AttendeeTile = forwardRef<HTMLLIElement, AttendeeTileProps>(
  ({ attendee, shouldDisplayAvatarRating, captainShouldDisplayPrice, props }, ref) => {
    ...
    return (
      <li ref={ref} className="grid bg-dark-red shadow-even shadow-burgundy/50" {...props}>
        {highlight && (
