...
export const teamRoleIcons: ReadonlyRecord<
  TeamRole,
  React.FC<Merge<Parameters<SVGIcon>[0], { secondaryClassName?: string }>>
> = {
  top: ({ secondaryClassName, ...props }) => (
